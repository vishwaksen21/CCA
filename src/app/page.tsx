...
const heroImages = ['/slide1.png', '/slide2.png', '/slide3.png', '/slide4.png', '/slide5.png', '/slide6.png','/slide9.png','/slide7.png','/slide8.png'];
        ...
        {Object.entries(winnersData)
          ...
          .map(([year, winners], idx) => (
            <motion.section
              ...
              viewport={{ once: true, amount: 0.2 }}
              id={`winners-${year}`}
              className={`w-full py-12 text-center ${ idx !== 0 ? 'mt-12' : ''}`}
            >
              <h2 className="text-3xl font-bold tracking-tighter text-center mb-4 font-headline uppercase text-accent">
                {year} Achievers
              </h2>

              <p className="max-w-3xl mx-auto text-lg text-foreground/80 mb-8">
              Honoring {year} CCA Achievers with top CAP points.
              </p>
              ...
              <div className="flex justify-center">
                <Image
                  ...
                  height={300}
                  unoptimized
                  className="rounded-md object-cover w-full max-w-3xl h-auto shadow-lg"
                />
              </div>
            </motion.section>
          ))}

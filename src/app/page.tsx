...
const upcomingWorkshops = [
  {
    ...
    date: '23rd & 27th September 2025',
    description:
      'Kickstarting your journey towards success with CCA’s guidance and opportunities.',
  ...
  },
  {
    ...
    description:
      'CCA Club x Bistro — where innovation meets flavor, serving creativity with a slice of deliciousness!',
    image: '/bistro.png',
  },
];
              ...
              <div className="px-2 sm:px-4 md:px-6 flex justify-center">
                <Card className="p-3 sm:p-4 md:p-6 shadow-lg w-full max-w-3xl">
                  <Image
                    ...
                    height={400}
                    unoptimized
                    className="rounded-lg object-cover w-full h-[150px] sm:h-[200px] md:h-[300px] mb-4"
                  />
